...
const Billing = () => {
  return (
    ...
    <div className={` relative ${layout.sectionImgReverse}`}>
      ...
      <div className='absolute z-[3] -left-1/2 top-o w-[50%] h-[50%] rounded-full white_gradient'/>

      <div className='absolute z-[0] -left-1/2 bottom-0 w-[50%] h-[50%] rounded-full pink_gradient'/>
      </div>
      <div className={layout.sectionInfo}>
        <h2 className={styles.heading2}>Easily control your <br sm:block hidden/> billing & invoicing.</h2>
